      ...
      <form action="<?php echo e(url('uf/confirmar')); ?>" method="post"  role="form">
         ...
         <div class="div_form">  
            ...
            <table border="0" width="100%">
               ...
               <tr>
                  <td><input  type='text' name="sigla_uf" value="<?php echo e($data->sigla_uf); ?>" size="3"  maxlength="2"  <?php echo e($readonly); ?> ></td>
                  <td><input  type='text' name="nome_uf"  value="<?php echo e($data->nome_uf); ?>"  size="60" maxlength="60" <?php echo e($readonly); ?> ></td>
               </tr>               
            </table> 
         </div>
