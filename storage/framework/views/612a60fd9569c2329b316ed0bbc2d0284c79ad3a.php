      ...
      <form action="<?php echo e(url('fornecedor/confirmar')); ?>" method="post"  role="form">
         ...
         <div class="div_form">  
            ...
            <table border="0" width="100%">
               ...
               <tr>
                  <td><input  type='text' name="codigo_fornecedor" value="<?php echo e($data->codigo_fornecedor); ?>" size="10" maxlength="10" <?php echo e($data->readonly); ?> ></td>
                  <td><input  type='text' name="nome_fornecedor"   value="<?php echo e($data->nome_fornecedor); ?>"   size="60" maxlength="60" <?php echo e($data->readonly); ?> ></td>
               </tr>               
            </table> 
         </div>
